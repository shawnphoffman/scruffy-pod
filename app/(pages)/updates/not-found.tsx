...
export default function NotFound() {
	return (
		<div className="flex flex-col items-center justify-center w-full gap-4 mt-2">
			<div className="flex flex-col w-full max-w-lg gap-2 p-4 px-8 mb-8 text-left border rounded-lg border-neutral-900 bg-neutral-950/75">
				...
				<Link href="/updates" className="flex flex-row items-center justify-center gap-2 text-2xl font-bold text-brand1 w-fit">
