...
export default function UrlEmbedLoader({ url, overrideTitle }: Props) {
	return (
		<Link
			href={url}
			target="_blank"
			className="flex flex-col justify-center gap-4 my-4 overflow-hidden transition-colors border rounded-lg hover:border-neutral-500 outline-offset-2 group embed border-brand-border bg-brand-background-transparent"
		>
